...
```js
// main style file
import 'react-date-range-with-time/dist/styles.css';
// theme css file
import 'react-date-range-with-time/dist/theme/default.css';
```
...
```
 ...
 NEW
 ```js
  import turkish from 'react-date-range-with-time/locale/tr';
